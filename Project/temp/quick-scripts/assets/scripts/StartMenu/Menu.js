(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/StartMenu/Menu.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3de02+8VlBLVZ49zbiOixbp', 'Menu', __filename);
// scripts/StartMenu/Menu.js
...
cc.Class({
    ...
    explosion: function explosion() {
        var blast = cc.instantiate(this.BlastPrefab1);
        ...
        var blast2 = cc.instantiate(this.BlastPrefab2);
        this.node.addChild(blast2);
        blast2.setPosition(this.player2.x, this.player2.y);
        var animComponent2 = blast2.getComponent(cc.Animation);
     ...
     * 功能：使UI动画中的对象发生旋转
     */
    updateRotatation: function updateRotatation() {
