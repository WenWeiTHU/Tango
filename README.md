...
**刘雍 2017013578 软件72** [**liuyong1095556447@gmail.com**](mailto:liuyong1095556447@gmail.com)

**刘旭鑫 2017013621 软件73** [**liuxuxin@outlook.com**](mailto:liuxuxin@outlook.com)
...
**刘雍**：摇杆移动控制，主角链接实现，技能；敌机类设计，继承，运动，攻击；镜头跟随，镜头切换，镜头过渡；动画效果，音效；无限模式，游戏数值调试，帮助向导，剧情设计，关卡设计（7-12关）；分包加载。

**刘旭鑫**：碰撞检测及回调，边界检测；地图类（含炮台）实现，分辨率适配；UI设计（角色图片，按钮，加载页和logo）；物理效果模拟；关卡设计（1-6关），模式选择界面；场景切换和本地存档，游戏暂停，排行榜。

 

**4.** 游戏概述**

![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image002.png)
...
![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image004.png)
...
| **名称**         | **图标**                                                     | **说明**                                                     |
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Enemy**        | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image006.jpg) | 以自转姿态运动，按初始设定的方向移动，碰到墙体反弹，主角碰撞后扣血（可被护盾抵挡），碰到链接后消失，以下敌人攻击方式均包含此类。 |
| **Enemy_static** | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image008.jpg) | 往往不会运动，被链接破坏后按一定速度向周围发射一定数目的Bullet。 |
| **Enemy_spin**   | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image010.jpg) | 以主角为原点做圆周运动，半径恰为主角之间链接长度（即不做出反应便会撞向另一侧的主角）。 |
| **Enemy_swing**  | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image012.jpg) | 常以整齐队列的形式移动，周期与位移可调。                     |
| **Enemy_track**  | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image014.jpg) | 具备追踪能力的敌机，初始速度较慢，会不断加速。               |
| **Enemy_Copter** | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image016.jpg) | 运动方式与Spin相同，定期向主角所在位置发射Bullet。           |
| **Battary**      | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image018.jpg) | 向主角定向发射一定数量的Bullet。属于地图类敌机，不可被破坏，主角碰撞与碰撞墙体类似。 |
| **Bullet**       | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image020.jpg) | 子弹，主角碰撞会扣血（可被护盾抵挡），只有碰到墙体或主角会消失，碰到链接不会消失。 |
| **Player**       | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image022.jpg) | 正确消灭敌机的方法是用主角之间的电流，若敌人直接碰到主角会扣血，随后主角有三秒中的无敌时间，两架战机中任何一架血量低于0则游戏结束。 |
| **Supply**       | ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image024.jpg) ![img](file:///C:/Users/qq109/AppData/Local/Temp/msohtmlclip1/01/clip_image026.jpg) | 主角触碰后相应地增加生命或护盾数                             |
...
如上一条所言。我们在游戏摄像机上做了深入尝试，当然不止于相机跟随，在一个普通场景中，我们设置了4台摄像机：UI Camera, Designer Camera, Map Camera, Main Camera，为了解决操纵杆触点的坐标系问题，我们专门使用了分离的两个相机：UI Camera用于渲染所有UI元素，Main Camera用于渲染游戏元素节点，Designer Camera是我们在地图设计时可以用方向键控制的移动相机，Map Camera用于界面切换时的相机缩放，为了达到连贯的游戏效果，我们借鉴了Pewpew的关卡过渡方法，在每个场景开始时会给我们设计的地图一个全局特写，然后镜头拉近直到我们的主角位于镜头中心，同样的，场景结束时同样会有此效果，一来让场景切换不显得那么突兀，二来让玩家在场景开始时对地图有个大致的认识。
...
这一次作业是我们进入大学以来第三次制作游戏。和前两次制作游戏不同的是，我们使用了成熟的游戏框架，并且使用github进行合作和版本控制。在有了游戏框架的帮助以后，我们发现很多基础的工作，例如碰撞检测、素材绑定、场景和各个素材的关系等，已经不需要自己操心，而是有现成的API可以进行调用。并且，有了框架的帮助以后，我们在开发中遇到的很多问题都可以在网络上和使用同样框架的程序员们进行探讨，同时也有很多前人的技术博客可供参考（这也显示了写技术博客的重要性）。
